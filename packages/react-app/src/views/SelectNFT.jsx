...
export default function SelectNFT({
  ...
  let itemList = ImageURIs.map((item,index)=>{
    ...
    return <div style={index == selectedIndex ? BorderStyle2 : BorderStyle }> <img src={item} alt="new" style = {ImageStyle} onClick={() => clickImage(index)}/> </div>
  })
      ...
      */}
      <div style={{ border: "1px solid #cccccc", padding: 16, width: 400, margin: "auto", marginTop: 64 }}>
        ...
        <Divider />
          ...
          <Button type="primary" onClick={selectedIndex != null ? showModal : undefined } style={{ background: "blue", borderColor: "blue" }}>
            List
          </Button>
